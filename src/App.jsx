                                        ...
                                        >
                                            {weeksInMonth.map((w, i) => (
                                                <option key={i} value={formatDateLocal(w.start)}>
                                                    {i + 1}주차 ({w.start.getMonth() + 1}.{w.start.getDate()} ~{' '}
                                                    {w.end.getMonth() + 1}.{w.end.getDate()})
                                                </option>
                                            ))}
                                        </select>
                                                ...
                                                {weekDays.map((day, i) => {
                                                    ...
                                                    const getScheduleItems = (gType) => {
                                                        ...
                                                        const getRealItems = (tStr) => {
                                                            ...
                                                            const merged = [...normal];
                                                            fixed.forEach((f) => {
                                                                if (!merged.some((n) => n.time === f.time))
                                                                    merged.push(f);
                                                            });
                                                            return merged;
                                                        };
                                                        ...
                                                        if (!hasReal) {
                                                            ...
                                                            const ghost00 = ghosts
                                                                .filter(
                                                                    (g) => g.date === dateStr && g.time === `${hour}:00`
                                                                )
                                                                .filter(filterValidGhost);
                                                            const ghost30 = ghosts
                                                                .filter(
                                                                    (g) => g.date === dateStr && g.time === `${hour}:30`
                                                                )
                                                                .filter(filterValidGhost);
                                                    ...
                                                    return (
                                                        <>
                                                            <span className="font-extrabold text-gray-800 text-sm whitespace-nowrap leading-none mb-1">
                                                                {weeks[0].label} ~{' '}
                                                                {weeks[11].end.getFullYear().toString().slice(2)}.
                                        ...
                                        {students
                                            .filter((s) => {
                                                if (attViewMode === 'month') {
                                                    ...
                                                    if (attCategory === 'monthly')
                                                        return isEffectivelyActive && s.isMonthly;
                                                    if (attCategory === 'artist')
                                                        return isEffectivelyActive && s.isArtist;
                                            ...
                                            .map((student, idx) => {
                                                ...
                                                const rotationStarts =
                                                    attCategory === 'basic'
                                                        ? calculateRotationStarts(student)
                                                        : new Set();
                                                ...
                                                return (
                                                    <tr key={student.id} className="text-center hover:bg-gray-50 group">
                                                        <td className="sticky left-0 bg-white group-hover:bg-gray-50 z-10 border-r border-gray-100 text-left pl-6 py-3 font-bold text-gray-800 align-middle border-b-[2px] border-gray-300">
                                                            ...
                                                            {attViewMode === 'month' &&
                                                                ...
                                                                (() => {
                                                                    ...
                                                                    const rateM = Number(student.rates?.master || 0);
                                                                    const rateV_Base = Number(
                                                                        student.rates?.vocal || 0
                                                                    );
                                                                    const rateV_Final = isV30
                                                                        ? rateV_Base * 0.5
                                                                        : rateV_Base;
                                                        ...
                                                        {weeks.map((w, i) => {
                                                            ...
                                                            const weekConfig =
                                                                student.schedule && student.schedule[rotationWeek - 1];
                                                            ...
                                                            const vCountBasic =
                                                                Number(weekConfig?.vocal || 0) +
                                                                Number(weekConfig?.vocal30 || 0);
                                                            ...
                                                            const extraMCount = weekSchedules
                                                                ...
                                                                .reduce(
                                                                    (acc, s) => acc + (s.masterType === '30' ? 0.5 : 1),
                                                                    0
                                                                );
                                                            ...
                                                            const renderSlot = (type, index, actualScheds) => {
                                                                ...
                                                                if (sched) {
                                                                    rotationInfo = getScheduleRotationInfo(
                                                                        student,
                                                                        sched.id
                                                                    );
                                                                }
                                                                ...
                                                                const manualStatus = manualRecord
                                                                    ? manualRecord.status
                                                                    : 'none';
                                                                ...
                                                                if (sched) {
                                                                    ...
                                                                    const isPending =
                                                                        !sched.status || sched.status === 'pending';
                                                                    ...
                                                                    if (sched.date === targetUiDate) {
                                                                        if (uiState === 'paid') {
                                                                            boxClass +=
                                                                                ' ring-2 ring-green-500 ring-offset-1 z-10';
                                                            ...
                                                            return (
                                                                <td
                                                                    key={i}
                                                                    className={`${cellBaseClass} ${cellStateClass}`}
                                                                >
                                    ...
                                    <table className="table w-full">
                                        <thead className="sticky top-0 bg-white z-10 shadow-sm">
                                            <tr className="text-gray-500 text-xs md:text-sm font-bold border-b-2 border-gray-100">
                                                ...
                                                <th className="hidden md:table-cell py-4 md:py-6">
                                                    등록일 / 재등록예정
                                                </th>
                                            ...
                                            {currentItems.map((student, idx) => {
                                                ...
                                                if (isExpanded) {
                                                    ...
                                                    historyTotalPages = Math.ceil(
                                                        combinedHistory.length / historyPerPage
                                                    );
                                            ...
                                            <tbody>
                                                {settlementIncome.map((item, i) => (
                                                    <tr
                                                        ...
                                                        onClick={() =>
                                                            handleGoToStudent(item.studentId, item.studentName)
                                                        }
                                                    >
                                            ...
                                            >
                                                ...
                                                {(() => {
                                                    const registeredCats = new Set(
                                                        currentMonthExpenses
                                                            .filter((e) => e.category !== '기타')
                                                            .map((e) => e.category)
                                                    );
                                                    // 현재 수정중인 항목의 카테고리는 선택 가능해야 함
                                                    if (editingExpenseId) {
                                                        const editingItem = expenses.find(
                                        ...
                                        {(() => {
                                            ...
                                            const existingWageExpense = expenses.find(
                                                (e) =>
                                                    e.category === '임금' &&
                                                    e.isVocalWage &&
                                                    e.targetMonth === currentMonthPrefix
                                            );
                                            ...
                                            return (
                                                <div className="mt-4 pt-4 border-t border-gray-100 bg-gray-50 rounded-xl p-4 mb-4">
                                                    ...
                                                    <div className="text-xs text-gray-500 mb-2">
                                                        {currentDate.getMonth() + 1}월 보컬추가 :{' '}
                                                        {formatCurrency(totalVocalWage)}원 (1H: 30,000 / 30m: 15,000)
                                                    </div>

                                                    <div className="bg-white rounded-lg border border-gray-200 mb-3 max-h-32 overflow-y-auto">
                                                        {vocalCompletedEvents.length === 0 ? (
                                                            <div className="text-center text-gray-300 py-3 text-xs">
                                                                해당 내역 없음
                                                            </div>
                                                        ) : (
                                                            <table className="table table-xs w-full">
                                                                        ...
                                                                        try {
                                                                            await updateDoc(
                                                                                doc(
                                                                                    db,
                                                                                    'expenses',
                                                                                    existingWageExpense.id
                                                                                ),
                                                                                {
                                                                                    paidDate: formatDateLocal(
                                                                                        new Date()
                                                                                    ),
                                                                                    memo:
                                                                                        existingWageExpense.memo +
                                                                                        ' [지급완료]',
                                                                                }
                                                                            );
                                                                            fetchSettlementData();
                        ...
                        <div className="flex-none flex items-center justify-between p-4 md:p-6 border-b border-gray-100 bg-white shadow-sm">
                            <div className="flex items-center gap-4">
                                <button
                                    ...
                                    className="btn btn-circle btn-ghost text-gray-500"
                                >
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-gray-400 font-bold mt-1 flex gap-2">
                                        ...
                                        <span className="text-blue-600">
                                            첫 수업일:{' '}
                                            {studentFullHistory.length > 0 ? studentFullHistory[0].date : '-'}
                                        </span>
                                    </p>
                                </div>
                            </div>
                                                ...
                                                <div className="min-w-max">
                                                    ...
                                                    <div className="flex border-b border-gray-100 pb-3 mb-3">
                                                        ...
                                                        {chunk.map((w) => (
                                                            <div
                                                                key={w.id}
                                                                className="w-16 md:w-20 shrink-0 text-center"
                                                            >
                                                    ...
                                                    <div className="flex items-start">
                                                        ...
                                                        {chunk.map((w) => {
                                                            ...
                                                            for (
                                                                ...
                                                                const dStr = formatDateLocal(d);
                                                                const isUnpaid = (
                                                                    viewingStudentAtt.unpaidList || []
                                                                ).some((u) => u.targetDate === dStr);
                                                                if (isUnpaid) {
                                                                    uiState = 'billed';
                                                                    targetUiDate = dStr;
                                                                    break;
                                                                        ...
                                                                        <div className="flex gap-1 justify-center flex-wrap min-h-[24px]">
                                                                            {completedM.length > 0 ? (
                                                                                completedM.map((s, idx) => {
                                                                                    const rotationInfo =
                                                                                        getLocalRotationInfo(s.id);
                                                                                    const dateShort = formatMonthDay(
                                                                                        s.date
                                                                                    );
                                ...
                                {scheduleTab === 'lesson' ? (
                                    ...
                                    <>
                                        <select
                                            ...
                                            onChange={(e) =>
                                                setScheduleForm({ ...scheduleForm, category: e.target.value })
                                            }
                                        >
                                            {scheduleForm.gridType === 'master' ? (
                                                <>
                                ...
                                <div className="form-control">
                                    <label className="label cursor-pointer justify-start gap-2">
                                        <input
                                            ...
                                            onChange={(e) =>
                                                setScheduleForm({ ...scheduleForm, isFixed: e.target.checked })
                                            }
                                        />
                                            ...
                                            <div className="flex flex-col gap-2 mt-1 pt-2 border-t border-blue-50">
                                                ...
                                                <div className="flex bg-gray-100 p-1 rounded-xl w-fit">
                                                    <button
                                                        type="button"
                                                        onClick={() =>
                                                            setScheduleForm((prev) => ({ ...prev, vocalType: '60' }))
                                                        }
                                                    ...
                                                    <button
                                                        type="button"
                                                        onClick={() =>
                                                            setScheduleForm((prev) => ({ ...prev, vocalType: '30' }))
                                                        }
                                                        className={`px-4 py-1.5 rounded-lg text-xs font-bold transition-all ${scheduleForm.vocalType === '30' ? 'bg-white text-blue-600 shadow-sm' : 'text-gray-400 hover:text-gray-600'}`}
                                                    >
                                                        30분 (1회)
                                    ...
                                    <div className="flex flex-col gap-3 mt-2 pt-2 border-t border-gray-200">
                                        <div className="flex flex-col gap-1">
                                            <label className="text-xs font-bold text-gray-400">
                                                추가 수업 ({scheduleForm.gridType === 'master' ? 'Master' : 'Vocal'}{' '}
                                                학생)
                                            </label>
                                            <select
                                                className="select select-sm border-gray-200 bg-gray-50"
                                        ...
                                        {(() => {
                                            const makeupList = historySchedules
                                                .filter(
                                                    (h) =>
                                                        h.status === 'reschedule' || h.status === 'reschedule_assigned'
                                                )
                                                .reduce((acc, h) => {
                                                    ...
                                                    if (
                                                        ...
                                                        !s.schedule?.some((w) => {
                                                            if (scheduleForm.gridType === 'master')
                                                                return Number(w.master || 0) > 0;
                                                            return (
                                                                Number(w.vocal || 0) > 0 || Number(w.vocal30 || 0) > 0
                                                            );
                                                        })
                                                    )
                                                        return acc;
                                                    ...
                                                    const alreadyAssigned = schedules.some(
                                                        (sch) =>
                                                            sch.studentId === h.studentId && sch.memo === expectedMemo
                                                    );
                                                    if (!alreadyAssigned) {
                                                ...
                                                <div className="flex flex-col gap-1">
                                                    ...
                                                    >
                                                        ...
                                                        {makeupList.map((h, i) => {
                                                            const isMaster =
                                                                h.gridType === 'master' ||
                                                                (!h.gridType && !h.vocalType);
                                                            const isVocal =
                                                                h.gridType === 'vocal' || (!h.gridType && h.vocalType);
                                    ...
                                    <div className="flex flex-col gap-1 mt-3">
                                        ...
                                        <div className="grid grid-cols-3 gap-2">
                                            {(() => {
                                                ...
                                                const isPast = new Date() > targetDateTime;
                                                const isMakeupAssignment =
                                                    scheduleForm.memo && scheduleForm.memo.includes('보강');
                                                ...
                                                return (
                                                    <>
                                                        ...
                                                        <button
                                                            ...
                                                            onClick={() =>
                                                                setScheduleForm((prev) => ({
                                                                    ...prev,
                                                                    status:
                                                                        prev.status === 'completed' ? '' : 'completed',
                                                                }))
                                                            }
                                                        ...
                                                        >
                                                            {scheduleForm.status === 'completed' && <FaCheckCircle />}{' '}
                                                            완료
                                                        </button>
                                                ...
                                                <div key={idx} className="grid grid-cols-7 gap-3 items-center">
                                                    ...
                                                    <div className="col-span-2">
                                                        <input
                                                            ...
                                                            value={week.master}
                                                            onChange={(e) =>
                                                                handleScheduleChange(idx, 'master', e.target.value)
                                                            }
                                                        />
                                                    </div>
                                                    <div className="col-span-2">
                                                        <input
                                                            ...
                                                            value={week.vocal}
                                                            onChange={(e) =>
                                                                handleScheduleChange(idx, 'vocal', e.target.value)
                                                            }
                                                        />
                                                    </div>
                                                    <div className="col-span-2">
                                                        <input
                                                            ...
                                                            value={week.vocal30}
                                                            onChange={(e) =>
                                                                handleScheduleChange(idx, 'vocal30', e.target.value)
                                                            }
                                                        />
                                                    </div>
                                                </div>
